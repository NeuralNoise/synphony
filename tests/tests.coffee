...
define [
  '../tests/client/db.spec'
  '../tests/client/model/named.spec'
  '../tests/client/model/grapheme.spec'
  '../tests/client/model/phoneme.spec'
  '../tests/client/model/gpc.spec'
  '../tests/client/model/user_gpc.spec'
  '../tests/client/model/word.spec'
  ...
  '../tests/client/collection/gpcs.spec'
  '../tests/client/collection/user_gpcs.spec'
  '../tests/client/collection/words.spec'
