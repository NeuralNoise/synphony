...
(function() {
  ...
  define(['backbone', 'view/common/layout', 'view/common/menu', 'view/common/sidebar', 'view/demo/words', 'view/demo/sentences', 'view/gpc/button', 'view/common/collection'], function(Backbone, Layout, MenuView, SidebarView, WordsView, SentencesView, GPCButtonView, CollectionView) {
    var DemoRouter;
