...
(function() {
  ...
  */
  ...
  GPCButtonView = (function(_super) {
    ...
    GPCButtonView.prototype.templateData = function() {
      ...
      return {
        ...
        name: (this.model.get('gpc')).get('name')
      };
    };
  ...
  GPCButtonsView = (function(_super) {
    ...
    GPCButtonsView.prototype.templateData = function() {
