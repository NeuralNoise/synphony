...
(function() {
  var ADMINDB, auth, compileStyle, express, fs, less, path, staticFile, staticPath, thedb, _;
  ...
  module.exports.run = function() {
    ...
    db.load(function(err) {
      if (err != null) {
        ...
        return db.ensureCollections(ADMINDB, ['users', 'projects'], function(err) {
          if (err != null) {
            return console.error(err.toString());
          }
        });
    ...
    deserializeUser = function(id, done) {
      var user;
      return user = db.get(ADMINDB, 'users', {
        _id: id
      }, function(err, user) {
        if (err != null) {
          console.log(err);
